...
- testing.md — `python -m swing_bot.test_frozen` must print GREEN (12 pinned refs at d=±0.0000pp + 19 invariants; 17 until 2026-09-06); plus FIVE standalone proofs, none needing network or DB: `prove_cache_guard` 8/8, `prove_refusal_gate` 10/10, `prove_liquidity_floor` 11/11 (was 6/6 before F3 — this line said 6/6 until 2026-09-05), `prove_feed_clock` 18/18, `prove_divergence_census` 16/16. A native pre-commit hook DOES run (secret scan + record invariants); no CI, no coverage tool. (updated 2026-09-05)
